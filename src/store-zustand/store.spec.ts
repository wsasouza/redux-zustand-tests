...
// declarado por fora do describe para pegar o estado inicial
...
describe('zustand store', () => {
  ...
  it('should not update the current module and lesson index ifthere is no next lesson available', () => {
    store.setState({ course })
